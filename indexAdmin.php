...
<html lang="en" dir="ltr">
  ...
  <body>
    <?php if (isset($_GET["tidakKonsisten"])) {
      echo "<script>
    ...
    <div class="main">
      <h3 align="center">Tentukanlah perbandingan prioritas dari hardware laptop menurut anda</h3>

      <form class="" action="hasiladmin.php" method="post">

        <table class="TInput" border="1" cellspadding ="10" cellspacing="0" align="center">
          <tr>
