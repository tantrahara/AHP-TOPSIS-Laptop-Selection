...
<body>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto align-items-center">
          <li class="nav-item ms-3">
            <a class="btn btn-black btn-rounded" href="table.php">Daftar Table</a>
            <a class="btn btn-black btn-rounded" href="logout.php">Logout</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <!-- Main -->
  <div class="main">
    <h2 align="center" class="p-3 text-danger"> TAHAP Metode AHP </h2>
    <h4 align="center" class="p-2">1. Tabel Matrix perbandingan berpasangan kriteria</h4>
    ...
    <h5 align="center" class="p-2">Jumlah tiap kolom</h5>
    <table class="table-light bg-secondary table-bordered border-dark mx-auto text-center">
      <tr>
        <th>Kolom 1</th>
        <th>Kolom 2</th>
        <th>Kolom 3</th>
    ...
    <h4 align="center" class="pt-4 pb-2"> 2. Normalisasi nilai matrix perbandingan berpasangan kriteria </h4>
    ...
    <h4 align="center" class="pt-4 pb-2"> 3. Tabel nilai W / Bobot tiap kriteria (Hasil AHP) </h4>
    ...
    echo '<table class="table-light bg-secondary table-bordered border-dark mx-auto text-center" cellspadding ="10" cellspacing="0" width="300px">';
    echo "<tr>";
    echo "<th>" . "W1" . "</th>";
    echo "<th>" . $w1 . "</th>";
    echo "</tr>";
    ...
    <h4 align="center" class="pt-4 pb-2"> 4. Perhitungan konsistensi </h4>
    <?php
    ...
    if ($CR < 0.1) {
      ...
      echo "<h4 align='center' class='text-success'>Konsisten</h4>";
      echo "<br>";
    } else {
    ...
    <h2 align="center" class="p-3 text-danger"> Tahap Metode TOPSIS </h2>
    <h4 align="center" class="p-2"> 1. Matrix keputusan yang ternormalisasi </h4>
    <?php
    ...
    echo "<h4 align='center' class='p-2'>Matrix normalisasi alternatif (Tabel R) </h4>";
    $objAHP->tampilMatrix($matrixAltNorm);
    ?>

    <h4 align="center" class="p-2"> 2. Matrix Normalisasi keputusan ternormalisasi terbobot </h4>
    <?php
    ...
    <h4 align="center" class="p-2"> 3. Matrix solusi ideal positif dan negatif </h4>
    <?php
    ...
    <h4 align="center" class="p-2"> 4. Jarak antara nilai setiap alternatif dengan matrix solusi ideal positif dan negatif </h4>
    <?php
    ...
    echo '<table class="table-light bg-secondary table-bordered border-dark mx-auto text-center">';
    ...
    echo '<table class="mt-2 table-light bg-secondary table-bordered border-dark mx-auto text-center">';
    echo "<tr class='fw-bold'>";
    echo "<td> Table D- </td>";
    echo "</tr>";
    foreach ($dNeg as $a) {
    ...
    <h4 align="center" class="p-2"> 5. Nilai preferensi untuk setiap alternatif (Hasil) </h4>
    ...
    $hasil = $objTOPSIS->query("SELECT alternatif, layar, processor, ram, harddisk, gpuvram, berat, FORMAT(harga, 0), V FROM laptops ORDER BY V DESC");
    ?>
